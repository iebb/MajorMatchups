...
const teamLogo = (code) => `https://img.majors.im/logos/2411_r6_blast_24s2_montreal/${code}.png`;
...
const TournamentStages = [
  {
    ...
    tournamentType: Formats.SwissBuchholtzTB_2024_R6_mod,
...
export default class R6MTL24 extends React.PureComponent {
  state = {
  ...
  render() {
    ...
    return (
        ...
        <div className="page-container">
          <Title
            title="BLAST R6 Major Montreal 2024 Simulator"
            sponsorLess
          />
          <BasicUI
            tabs={tabs}
