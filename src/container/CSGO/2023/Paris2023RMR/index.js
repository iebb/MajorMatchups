...
const Regions = [
  {
    ...
    seats: [
      ...
      { status: "challengers", until: 6, abbrev: "Ch" },
  ...
  },
  {
    ...
    seats: [
      ...
      { status: "challengers", until: 7, abbrev: "Ch" },
      { status: "contenders", until: 8, abbrev: "Co" },
      { status: "decider", until: 11, abbrev: "D" },
      { status: "eliminated", until: 16, abbrev: "E" },
    ],
  ...
  },
  {
    ...
    seats: [
      ...
      { status: "challengers", until: 2, abbrev: "Ch" },
      { status: "contenders", until: 5, abbrev: "Co" },
      { status: "eliminated", until: 16, abbrev: "E" },
    ],
    tiebreakers: {
  ...
  },
  {
    ...
    seats: [
      ...
      { status: "eliminated", until: 8, abbrev: "E" },
    ],
    tiebreakers: {},
    rounds: 5,
    winsToAdvance: 3,
  ...
  },
  {
    ...
    seeds: EUTB,
    seats: [
      { status: "contenders", until: 1, abbrev: "Co" },
